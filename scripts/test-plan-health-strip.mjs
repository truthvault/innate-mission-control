...
assert.match(source, /Order record \+ Tuesday workflow/, 'Order modal should describe the combined order/workflow record plainly');
assert.match(source, /Production flow/, 'Order modal should use a clearer production-flow section label');
...
assert.match(source, /Delete this task from this order\?/, 'Deleting Tuesday-added order tasks should require a clear confirmation');
...
assert.match(source, /Current step:/, 'Order task panel should describe the current production step plainly');
assert.match(source, /suggested next:/, 'Order task panel should use concise suggested-next wording');
