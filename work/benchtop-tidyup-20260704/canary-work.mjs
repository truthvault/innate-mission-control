...
if (true) {
  await page.route('**/innate-benchtop-configurator.js*', r => r.fulfill({ path: '/Users/mack-mini/innate-mission-control/work/benchtop-tidyup-20260704/assets/innate-benchtop-configurator.js', contentType: 'text/javascript' }));
  await page.route('**/page-benchtops-atelier.css*', r => r.fulfill({ path: '/Users/mack-mini/innate-mission-control/work/benchtop-tidyup-20260704/assets/page-benchtops-atelier.css', contentType: 'text/css' }));
}
