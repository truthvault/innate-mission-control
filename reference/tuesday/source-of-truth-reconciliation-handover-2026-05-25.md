...
Status: handover only. No Tuesday app/code changes were made in this pass.
...
1. Supabase leads/orders as canonical records.
2. Monday Orders as workshop mirror status only.
...
- Supabase canonical status = source of truth.
- Monday mirror status = workshop mirror.
...
If Monday disagrees with these, Monday is lagging and should be treated as mirror drift, not canonical truth.
