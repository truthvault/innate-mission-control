-- Supabase-first production order intake spine for approved Tuesday-owned records.
-- Current rule as of 2026-06-15: Supabase/Tuesday is forward truth for leads and approved Tuesday-owned records; Monday remains current workshop/legacy truth for production tasks, stock, and customer history until migration gates are met; Xero remains accounting authority.
