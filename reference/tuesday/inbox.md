# Tuesday lane: Inbox / untriaged ideas

Created: 2026-05-17

## Purpose
Catch gym-mode ideas that do not clearly belong to one lane yet.

## Rules
- Default unclear ideas here instead of interrupting Guido mid-flow.
- Move/dedupe into the right lane during synthesis.
- Keep original wording when it contains important product language.
