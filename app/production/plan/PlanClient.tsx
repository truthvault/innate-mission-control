...
import { startTransition, type CSSProperties, type DragEvent, type MouseEvent, type ReactNode, useCallback, useEffect, useId, useMemo, useRef, useState } from "react";
import {
  closestCorners,
  pointerWithin,
  DndContext,
...
function MonthViewState({
  ...
  const handlePlanViewModeClick = useCallback((event: MouseEvent<HTMLAnchorElement>, mode: ProductionPlanMode) => {
