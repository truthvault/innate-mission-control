...
import type { DelightOrigin } from "./delight";
import { OrderPhotoTray } from "./order-photo-tray";

// Delight canvas engine is heavy; load it only when a celebration fires.
const DelightDoneBurst = dynamicImport(() => import("./delight").then((m) => m.DelightDoneBurst), { ssr: false });
const DelightUnicorn = dynamicImport(() => import("./delight").then((m) => m.DelightUnicorn), { ssr: false });
import {
