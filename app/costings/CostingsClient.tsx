  ...
  return (
    <section className="costings-command" aria-label="Costings command view">
      <style>{`
        ...
        .costings-alpha-rail{position:sticky;top:86px;display:grid;gap:2px;padding:8px 5px;background:#ffffffdf9;border:1px solid rgba(39,34,27,.16);border-radius:999px;box-shadow:0 18px 42px rgba(39,34,27,.11);backdrop-filter:blur(12px)}
        ...
        .costings-directory-toolbar span{display:block;color:${DT.textSecondary};font-family:${DT.sans};font-size:9px;font-weight:950;text-transform:uppercase;letter-spacing:.08em}.costings-directory-toolbar strong{display:block;color:${DT.textPrimary};font-family:${DT.serif};font-size:21px;line-height:1.05}.costings-directory-toolbar input,.costings-directory-toolbar select{min-width:0;height:44px;border:1px solid rgba(39,34,27,.18);border-radius:999px;background:#fffffffff;color:${DT.textPrimary};font-family:${DT.sans};font-size:12px;font-weight:850;padding:0 14px;outline:none;box-shadow:inset 0 1px 0 rgba(255,255,255,.8),0 1px 2px rgba(39,34,27,.04)}
        .costings-directory-filters{display:flex;gap:6px;flex-wrap:wrap}.costings-directory-filters button{min-height:40px;border:1px solid rgba(39,34,27,.14);border-radius:999px;background:#ffffffdf9;color:${DT.textSecondary};font-family:${DT.sans};font-size:11px;font-weight:950;padding:0 12px;cursor:pointer;touch-action:manipulation;box-shadow:0 1px 2px rgba(39,34,27,.035)}.costings-directory-filters button[aria-pressed="true"]{background:${DT.headerBg};border-color:${DT.headerBg};color:#ffffff;box-shadow:0 8px 20px rgba(39,34,27,.18)}
        ...
        .costings-edit-field input,.costings-edit-field select,.costings-edit-field textarea{min-width:0;width:100%;min-height:40px;box-sizing:border-box;border:1px solid rgba(39,34,27,.10);background:#ffffffdf9;border-radius:7px;color:${DT.textPrimary};font-family:${DT.sans};font-size:12px;font-weight:800;padding:8px 9px;outline:none}
