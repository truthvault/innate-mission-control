  ...
  return (
    <section className="costings-command" aria-label="Costings command view">
      <style>{`
        ...
        .costings-health span{display:block;overflow:visible;text-overflow:clip;white-space:normal;color:${DT.textFaint};font-family:${DT.sans};font-size:8.5px;font-weight:950;text-transform:uppercase;letter-spacing:.04em;line-height:1.15}
        ...
        .costings-alpha-rail{position:sticky;top:86px;display:grid;gap:2px;padding:8px 5px;background:#fffdf8;border:1px solid rgba(44,37,32,.16);border-radius:999px;box-shadow:0 18px 42px rgba(44,37,32,.11);backdrop-filter:blur(12px)}
        .costings-alpha-rail button{width:30px;height:20px;border:0;border-radius:999px;background:transparent;color:${DT.textSecondary};font-family:${DT.sans};font-size:10px;font-weight:950;cursor:pointer;transition:background 140ms ease,color 140ms ease,transform 140ms ease}.costings-alpha-rail button:hover:not(:disabled){background:${DT.headerBg};color:#fff;transform:scale(1.08)}.costings-alpha-rail button:disabled{opacity:.26;cursor:default}
        .costings-directory-main{display:grid;gap:10px;min-width:0}.costings-directory-toolbar{position:sticky;top:73px;z-index:20;display:grid;grid-template-columns:minmax(170px,1fr) minmax(240px,1.4fr) 190px;gap:8px;align-items:center;padding:11px;background:#f2eee6;border:1px solid rgba(44,37,32,.14);border-radius:16px;box-shadow:0 12px 30px rgba(44,37,32,.13);backdrop-filter:blur(14px)}
        .costings-directory-toolbar span{display:block;color:${DT.textSecondary};font-family:${DT.sans};font-size:9px;font-weight:950;text-transform:uppercase;letter-spacing:.08em}.costings-directory-toolbar strong{display:block;color:${DT.textPrimary};font-family:${DT.serif};font-size:21px;line-height:1.05}.costings-directory-toolbar input,.costings-directory-toolbar select{min-width:0;height:44px;border:1px solid rgba(44,37,32,.18);border-radius:999px;background:#ffffff;color:${DT.textPrimary};font-family:${DT.sans};font-size:12px;font-weight:850;padding:0 14px;outline:none;box-shadow:inset 0 1px 0 rgba(255,255,255,.8),0 1px 2px rgba(44,37,32,.04)}
        .costings-directory-filters{display:flex;gap:6px;flex-wrap:wrap}.costings-directory-filters button{min-height:40px;border:1px solid rgba(44,37,32,.14);border-radius:999px;background:#fffdf8;color:${DT.textSecondary};font-family:${DT.sans};font-size:11px;font-weight:950;padding:0 12px;cursor:pointer;touch-action:manipulation;box-shadow:0 1px 2px rgba(44,37,32,.035)}.costings-directory-filters button[aria-pressed="true"]{background:${DT.headerBg};border-color:${DT.headerBg};color:#fff;box-shadow:0 8px 20px rgba(44,37,32,.18)}
        .costings-material-list{display:grid;gap:9px}.costings-letter-heading{position:sticky;top:146px;z-index:10;width:max-content;margin:11px 0 3px;padding:4px 11px;border-radius:999px;background:${DT.headerBg};color:#fff;font-family:${DT.serif};font-size:19px;line-height:1;box-shadow:0 10px 20px rgba(44,37,32,.18)}
        .costings-material-row{overflow:hidden;border:1px solid rgba(44,37,32,.14);border-radius:16px;background:#fffdf8;box-shadow:0 2px 7px rgba(44,37,32,.055);transition:box-shadow 160ms ease,border-color 160ms ease,transform 160ms ease}.costings-material-row:hover{border-color:rgba(12,124,122,.34);box-shadow:0 15px 38px rgba(44,37,32,.12);transform:translateY(-1px)}.costings-material-row[data-expanded="true"]{border-color:rgba(12,124,122,.38);box-shadow:0 22px 48px rgba(44,37,32,.14)}
        .costings-material-summary{width:100%;display:grid;grid-template-columns:minmax(260px,1.5fr) minmax(150px,.45fr) minmax(170px,.62fr) 72px;gap:12px;align-items:center;padding:15px 16px;border:0;background:transparent;text-align:left;cursor:pointer}.costings-material-summary span{min-width:0}.costings-material-name strong{display:block;color:${DT.textPrimary};font-family:${DT.sans};font-size:15.5px;font-weight:950;line-height:1.25;overflow-wrap:anywhere}.costings-material-name em{display:block;margin-top:4px;color:${DT.textSecondary};font-family:${DT.sans};font-size:11.5px;font-style:normal;font-weight:850}.costings-material-price{padding:8px 10px;border-radius:12px;background:#f4efe6;border:1px solid rgba(44,37,32,.08)}.costings-material-price strong{display:block;color:${DT.textPrimary};font-family:${DT.serif};font-size:18.5px;line-height:1}.costings-material-price small,.costings-material-proof small{display:block;margin-top:4px;color:${DT.textMuted};font-family:${DT.sans};font-size:10.5px;font-weight:900;line-height:1.25}.costings-material-proof{display:grid;justify-items:start;gap:4px}.costings-material-expand{justify-self:end;display:inline-flex;align-items:center;justify-content:center;min-height:34px;padding:0 12px;border-radius:999px;background:rgba(44,37,32,.075);color:${DT.textPrimary};font-family:${DT.sans};font-size:11px;font-weight:950}.costings-material-row[data-expanded="true"] .costings-material-expand{background:${DT.headerBg};color:#fff}
        .costings-material-expanded{padding:0 12px 12px}.costings-material-expanded .costings-detail-card{box-shadow:none;border-radius:12px;background:#fffdf8;border-color:rgba(44,37,32,.14)}.costings-material-expanded .costings-detail-hero h2{font-size:22px}.costings-material-expanded .costings-detail-hero{display:none}
        ...
        .costings-rail-main{min-width:0}.costings-rail-main strong{display:block;color:${DT.textPrimary};font-family:${DT.sans};font-size:13px;font-weight:950;line-height:1.2;overflow:visible;text-overflow:clip;white-space:normal;overflow-wrap:anywhere}.costings-rail-main span{display:block;margin-top:4px;color:${DT.textMuted};font-family:${DT.sans};font-size:10px;font-weight:750;overflow:visible;text-overflow:clip;white-space:normal;overflow-wrap:anywhere}.costings-rail-main em{display:block;margin-top:5px;color:${DT.textSecondary};font-family:${DT.sans};font-size:10px;font-style:normal;font-weight:850;line-height:1.25}
        ...
        .costings-edit-field{min-width:0;display:grid;gap:5px;border:1px solid rgba(44,37,32,.07);background:#f8f5ef;border-radius:8px;padding:8px;font-family:${DT.sans}}
        .costings-edit-field>span{display:flex;align-items:center;justify-content:space-between;gap:8px;color:${DT.textFaint};font-size:9px;font-weight:950;text-transform:uppercase;letter-spacing:.06em}
        .costings-edit-field>span em{font-style:normal;color:${DT.textMuted};font-size:8.5px;text-transform:none;letter-spacing:0}
        .costings-edit-field input,.costings-edit-field select,.costings-edit-field textarea{min-width:0;width:100%;min-height:40px;box-sizing:border-box;border:1px solid rgba(44,37,32,.10);background:#fffdf9;border-radius:7px;color:${DT.textPrimary};font-family:${DT.sans};font-size:12px;font-weight:800;padding:8px 9px;outline:none}
        .costings-edit-field textarea{resize:vertical;line-height:1.35}
        .costings-edit-field input:disabled,.costings-edit-field select:disabled,.costings-edit-field textarea:disabled{background:rgba(44,37,32,.035);color:${DT.textFaint};cursor:not-allowed}
        .costings-edit-field small,.costings-toggle small{color:${DT.textFaint};font-size:9px;font-weight:850;line-height:1.25}
        .costings-edit-field small[data-state="saving"],.costings-toggle small[data-state="saving"]{color:#8a5b1f}.costings-edit-field small[data-state="saved"],.costings-toggle small[data-state="saved"]{color:${DT.green}}.costings-edit-field small[data-state="error"],.costings-toggle small[data-state="error"]{color:#991b1b}
        .costings-toggle{min-width:0;display:flex;align-items:center;gap:8px;border:1px solid rgba(44,37,32,.07);background:#f8f5ef;border-radius:8px;padding:8px;color:${DT.textPrimary};font-family:${DT.sans};font-size:12px;font-weight:900}
